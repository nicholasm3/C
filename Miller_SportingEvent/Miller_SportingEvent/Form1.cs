...
namespace Miller_SportingEvent
{
    public partial class fRegister : Form
    {
        ...
        private void SetRadioImage(int i)
        {
            if (i >= 0)
            {
                if (i == 0) { pBxSport.Image = Miller_SportingEvent.Properties.Resources.skiing; }
                else if (i == 1) { pBxSport.Image = Miller_SportingEvent.Properties.Resources.baseball; }
                else if (i == 2) { pBxSport.Image = Miller_SportingEvent.Properties.Resources.basketball; }
                else if (i == 3) { pBxSport.Image = Miller_SportingEvent.Properties.Resources.football; }
                else if (i == 4) { pBxSport.Image = Miller_SportingEvent.Properties.Resources.soccer; }
            ...
            {
                pBxSport.Image = Miller_SportingEvent.Properties.Resources.sports;
                tBxSport.Text = "Please pick a sport on the left.";
            }
        }
        ...
        private void infoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Name:\t\tNicholas Miller" +
                ...
                "Assignment:\tAssignment 9 - Sporting Event App\n" +
        ...
        private void fRegister_Load_1(object sender, EventArgs e)
        {
